...
if [ ! -d $TARGET_ROOTFS_DIR ] ; then
    ...
    if [ ! -e ubuntu-base-24.04.2-base-$ARCH.tar.gz ]; then
        echo "\033[36m wget ubuntu-base-24.04.2-base-"$ARCH".tar.gz \033[0m"
        wget -c http://cdimage.ubuntu.com/ubuntu-base/releases/24.04/release/ubuntu-base-24.04.2-base-$ARCH.tar.gz
    fi
    sudo tar -xzf ubuntu-base-24.04.2-base-$ARCH.tar.gz -C $TARGET_ROOTFS_DIR/
